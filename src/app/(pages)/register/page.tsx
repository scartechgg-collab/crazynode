      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="relative z-10 w-full max-w-md px-4">
        <div className="premium-card p-8 lg:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">Join CrazyNode today</p>
          </div>
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="relative">
                ...
                <input value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="John Doe" className="w-full pl-11 pr-4 py-3 bg-dark-bg border border-dark-border rounded-xl text-sm text-white placeholder-gray-600 focus:border-brand/50 focus:outline-none" />
              </div>
            </div>
            <div>
